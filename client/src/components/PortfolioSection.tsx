  ...
  const projects = [
    {
      ...
      image: '/images/luxprime-screenshot.webp',
      link: 'https://hebertabchm-dotcom.github.io/projeto-imobiliario-gpt01/',
    },
    {
      id: 2,
      title: 'AurumVista Imobiliária',
      category: 'Imobiliária',
      ...
      tags: ['HTML5', 'CSS3', 'JavaScript'],
      image: '/images/aurumvista-screenshot.webp',
