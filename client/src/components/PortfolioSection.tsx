      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="section-subtitle">
            Seleção de projetos Front-End desenvolvidos com HTML5, CSS3 e
            JavaScript, demonstrando interfaces modernas, responsivas e com
            ...
            >
              <div className="relative h-full bg-card border border-border rounded-2xl overflow-hidden transition-all duration-500 hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/10 hover:-translate-y-1 flex flex-col">
                ...
                <div className="relative h-56 md:h-64 overflow-hidden bg-muted flex-shrink-0">
                  ...
                  {/* Imagem principal (ajuste do rosto dentro do card) */}
                  <img
                    src={project.image}
                    alt={project.title}
                    loading="lazy"
                    className="relative z-10 w-full h-full object-cover object-[40%_40%] transition-transform duration-500 ease-out group-hover:scale-105"
                  />
